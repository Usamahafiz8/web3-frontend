...
export const section4Content = {
  top: {
    ...
    subtitle:
      "Charity App instantly analyzes thousands of quotes and fees across multiple DEXes to provide users with the best rates.",
    image: NewsImg,
  },
  bottom: {
    title: "Charity App DeFi Wallet",
    TABS: [
      {
        name: "Buy",
        image: Phone1Img,
      ...
      },
      {
        ...
        image: Phone2Img,
        subtitle:
          "Stake Charity App to participate in network governance and be eligible for gas costs refunds.",
      },
    ],
  },
};
...
export const section5Content = {
  BannerBgImage,
  BannerBgImageMobile,
  title: "Charity App Fusion",
  subtitle:
    "The Fusion upgrade makes swaps on Charity App yet more efficient and secure, combining liquidity from the entire crypto market in one place.",
};

export const section6Content = {
  title: "Charity App products",
  ITEMS: [
    {
...
export const section7Content = {
  ...
  ITEMS: [
    ...
    {
      title: "Charity App grant program",
      subtitle:
        "An initiative that fosters the Charity App Network's growth and incentivizes contributions through grants and other resources.",
      image: Sec7Image2,
    },
  ],
};
...
export const section8Content = {
  ...
  subtitle:
    "Charity App uses sophisticated security measures to protect users' funds in swaps on other DeFi protocols",
  caption:
    "Charity App is the most audited project in DeFi. See a list of the most important smart contract audits here.",
  ShieldImage,
};
...
export const section9Content = {
  ...
  ITEMS: [
    {
      title: "Charity App DAO",
      subtitle:
        "A governance tool that enables Charity App stakers to vote for key protocol parameters.",
      image: Sec9Image1,
    },
    {
      title: "Charity App token",
      subtitle:
        "A token that facilitates Charity App protocol governance and participation in the network's evolution.",
      image: Sec9Image2,
    },
  ],
};
...
export const footerContent = {
  ...
  subscribe: {
    title: "Subscribe to Charity App newsletter",
  ...
  copyright: {
    left: "© 2023 Charity App, All Rights Reserved.",
    center: "ENS: Charity App",
